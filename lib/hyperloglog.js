// +----------------------------------------------------------------------+
// | HyperLogLog v0.1.2 (https://github.com/optimizely/hyperloglog)       |
...
// ### NOTICE ###
// this version has been modified to use different hash lib.
// as well as generating the hash internally thus accepting value directly.

'use strict';

var murmur = require('./murmurhash');
var hash = murmur.x86.hash128;
